...
<div className= 'hidden  top-6 w-25 right-4  absolute sm:group-hover:flex text-white text-sm bg-gray-800 rounded-lg p-2 text-center justify-center items-center'>Delete Post</div>
    </div>
    <div className='group'>
...
setEditPost(true)
      ...
      <div className= 'hidden transition-all dur absolute w-20 top-6 text-white sm:group-hover:flex left-0 bg-gray-800 rounded-lg p-2 text-sm text-center justify-center items-center'>Edit Post</div>
    </div>
      </div>
